                            ...
                            <form method="post" action="/lessons/update/${lesson.id}">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="${lesson.name}" name="name" class="form-control" id="exampleInputEmail1"
                                               required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail4">Video path</label>
                                        <input type="text" name="video_path" class="form-control"
                                               id="exampleInputEmail4" required value="${lesson.vide_path}"
                                        >
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="module_id">
                                            <c:forEach var="module" items="${modules}">
                                                <c:if test="${module.id==lesson.moduleid}">
